...
void jogo(JOGO copia_controle){ //ok
    ...
    int flag_gravidade=TRUE;// dai é só  nós definirmos o que vai fazer o que  vale cada indicie tipo inidice 0=mario e ec
   ...
   {
         tempo_geral=clock();
        flag_altera_score= habilita_movimento(flag_altera_score,&tempo_score,tempo_geral,'Ç' );
